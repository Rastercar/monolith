...
export type KIT_ROUTES = {
  ...
  SERVERS: { 'POST /auth/confirm-email-address': never, 'POST /auth/request-email-confirmation': never, 'POST /auth/sign-out': never, 'DELETE /auth/sign-out/[session_id=integer]': 'session_id', 'GET /client/access-levels': never, 'DELETE /client/access-levels/[access_level_id=integer]': 'access_level_id', 'PUT /client/settings/profile/picture': never, 'DELETE /client/settings/profile/picture': never, 'GET /client/tracking/sim-cards': never, 'DELETE /client/tracking/sim-cards/[sim_card_id=integer]': 'sim_card_id', 'PUT /client/tracking/sim-cards/[sim_card_id=integer]': 'sim_card_id', 'GET /client/tracking/trackers': never, 'DELETE /client/tracking/trackers/[tracker_id=integer]': 'tracker_id', 'GET /client/tracking/trackers/[tracker_id=integer]/last-location': 'tracker_id', 'GET /client/tracking/trackers/[tracker_id=integer]/locations': 'tracker_id', 'GET /client/tracking/vehicles': never, 'DELETE /client/tracking/vehicles/[vehicle_id=integer]': 'vehicle_id', 'PUT /client/tracking/vehicles/[vehicle_id=integer]/photo': 'vehicle_id', 'DELETE /client/tracking/vehicles/[vehicle_id=integer]/photo': 'vehicle_id', 'GET /client/users': never, 'DELETE /client/users/[user_id=integer]': 'user_id', 'PUT /client/users/[user_id=integer]/access-level': 'user_id', 'DELETE /client/users/[user_id=integer]/sessions/[session_id=integer]': 'user_id' | 'session_id' }
  ACTIONS: { 'changePassword /auth/change-password': never, 'recoverPassword /auth/recover-password': never, 'signIn /auth/sign-in': never, 'signUp /auth/sign-up': never, 'updateAccessLevel /client/access-levels/[access_level_id=integer]': 'access_level_id', 'createAccessLevel /client/access-levels/new': never, 'updateOrganization /client/settings/organization': never, 'updateProfile /client/settings/profile': never, 'updateProfilePicture /client/settings/profile': never, 'changePassword /client/settings/security': never, 'updateSimCard /client/tracking/sim-cards/[sim_card_id=integer]': 'sim_card_id', 'createSimCard /client/tracking/sim-cards/new': never, 'updateTracker /client/tracking/trackers/[tracker_id=integer]': 'tracker_id', 'createTracker /client/tracking/trackers/new': never, 'createVehicle /client/tracking/vehicles/new': never, 'createUser /client/users/new': never }
