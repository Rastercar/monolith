...
export type KIT_ROUTES = {
  ...
  SERVERS: { 'GET /auth/sign-in': never, 'POST /auth/sign-out': never }
  ACTIONS: { 'default /auth/recover-password': never, 'default /auth/sign-in': never }
