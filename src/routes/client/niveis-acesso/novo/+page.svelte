...
<form
	...
	method="POST"
	datatype="json"
	action={route('createAccessLevel /client/niveis-acesso/novo')}
	use:sForm.enhance
>
	<PageHeader
		...
		breadCrumbs={[
			...
			{ href: route('/client/niveis-acesso'), icon: 'mdi:shield', text: 'níveis de acesso' },
			{ href: route('/client/niveis-acesso/novo'), text: 'cadastro' }
		]}
	/>
