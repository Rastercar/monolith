		...
		},
		{
			...
			cell: ({ row }) =>
				renderComponent(InfoIconLink, {
					href: route('/client/rastreamento/rastreadores/[tracker_id=integer]', {
...
<PageContainer>
	<PageHeader
		...
		breadCrumbs={[
			...
			{ text: 'rastreamento' },
			{
				href: route('/client/rastreamento/rastreadores'),
				icon: 'mdi:cellphone',
				text: 'rastreadores'
			}
		]}
	...
	<div class="flex mb-4 items-center space-x-4">
		...
		<CreateEntityButton
			href={route('/client/rastreamento/rastreadores/novo')}
