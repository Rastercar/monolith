...
const ACTIONS = {
  ...
  "signIn /client/settings/profile": `/client/settings/profile?/signIn`
}
...
export type KIT_ROUTES = {
  ...
  ACTIONS: { 'changePassword /auth/change-password': never, 'recoverPassword /auth/recover-password': never, 'signIn /auth/sign-in': never, 'signUp /auth/sign-up': never, 'signIn /client/settings/profile': never }
